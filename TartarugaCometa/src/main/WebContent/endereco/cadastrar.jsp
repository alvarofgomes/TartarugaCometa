...
<body>
	...
	<form action="/TartarugaCometa/enderecoCadastrar" method="post">
		...
		Numero: <input type="text" name="numero" maxlength="10" required><br><br>
		...
		Estado: <input type="text" name="estado" maxlength="20" required><br><br>
		Cep: <input type="text" name="cep" maxlength="9" inputmode="numeric" oninput="this.value = this.value.replace(/\D/g, '')" required><br><br>
