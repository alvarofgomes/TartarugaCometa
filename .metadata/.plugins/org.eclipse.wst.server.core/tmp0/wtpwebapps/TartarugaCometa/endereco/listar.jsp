	...
	<ul>
	    <c:forEach items="${enderecos}" var="endereco">
	        <li>
	            ...
	            <a href="removeEndereco?id=${endereco.id}" onclick="return confirm('Tem certeza que deseja remover este endereco?');">Remover</a>
	        </li>
	        <hr>
	    </c:forEach>
	</ul>
	
	<a href="/TartarugaCometa/enderecoCadastrar"><input type="submit" value="Cadastrar novo endereço" /></a>
    <br><br>
